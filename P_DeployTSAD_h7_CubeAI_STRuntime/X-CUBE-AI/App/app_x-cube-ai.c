...
#if !defined(AI_NETWORK_1701866511190_INPUTS_IN_ACTIVATIONS)
AI_ALIGNED(4) ai_i8 data_in_1[AI_NETWORK_1701866511190_IN_1_SIZE_BYTES];
ai_i8* data_ins[AI_NETWORK_1701866511190_IN_NUM] = {
data_in_1
};
#else
ai_i8* data_ins[AI_NETWORK_1701866511190_IN_NUM] = {
...
#if !defined(AI_NETWORK_1701866511190_OUTPUTS_IN_ACTIVATIONS)
AI_ALIGNED(4) ai_i8 data_out_1[AI_NETWORK_1701866511190_OUT_1_SIZE_BYTES];
ai_i8* data_outs[AI_NETWORK_1701866511190_OUT_NUM] = {
data_out_1
};
#else
ai_i8* data_outs[AI_NETWORK_1701866511190_OUT_NUM] = {
...
AI_ALIGNED(32)
static uint8_t pool0[AI_NETWORK_1701866511190_DATA_ACTIVATION_1_SIZE];

ai_handle data_activations0[] = {pool0};

/* AI objects ----------------------------------------------------------------*/

static ai_handle network_1701866511190 = AI_HANDLE_NULL;
...
static int ai_boostrap(ai_handle *act_addr)
{
  ...
  err = ai_network_1701866511190_create_and_init(&network_1701866511190, act_addr, NULL);
  if (err.type != AI_ERROR_NONE) {
    ai_log_err(err, "ai_network_1701866511190_create_and_init");
    return -1;
  }

  ai_input = ai_network_1701866511190_inputs_get(network_1701866511190, NULL);
  ai_output = ai_network_1701866511190_outputs_get(network_1701866511190, NULL);
...
static int ai_run(void)
{
  ...
  batch = ai_network_1701866511190_run(network_1701866511190, ai_input, ai_output);
  if (batch != 1) {
    ai_log_err(ai_network_1701866511190_get_error(network_1701866511190),
        "ai_network_1701866511190_run");
    return -1;
  }
