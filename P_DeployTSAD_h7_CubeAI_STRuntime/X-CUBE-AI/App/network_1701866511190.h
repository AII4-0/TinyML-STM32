...
#ifndef AI_NETWORK_1701866511190_H
#define AI_NETWORK_1701866511190_H
#pragma once

#include "network_1701866511190_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_1701866511190_MODEL_NAME          "network_1701866511190"
#define AI_NETWORK_1701866511190_ORIGIN_MODEL_NAME   "gan_0_quant"

/******************************************************************************/
#define AI_NETWORK_1701866511190_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_1701866511190_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_1701866511190_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_1701866511190_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_1701866511190_IN \
  ai_network_1701866511190_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1701866511190_IN_SIZE { \
  AI_NETWORK_1701866511190_IN_1_SIZE, \
}
#define AI_NETWORK_1701866511190_IN_SIZE_BYTES { \
  AI_NETWORK_1701866511190_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_1701866511190_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_1701866511190_IN_1_HEIGHT      (99)
#define AI_NETWORK_1701866511190_IN_1_CHANNEL     (1)
#define AI_NETWORK_1701866511190_IN_1_SIZE        (99 * 1)
#define AI_NETWORK_1701866511190_IN_1_SIZE_BYTES  (396)

/******************************************************************************/
#define AI_NETWORK_1701866511190_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_1701866511190_OUT \
  ai_network_1701866511190_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_1701866511190_OUT_SIZE { \
  AI_NETWORK_1701866511190_OUT_1_SIZE, \
}
#define AI_NETWORK_1701866511190_OUT_SIZE_BYTES { \
  AI_NETWORK_1701866511190_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_1701866511190_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_1701866511190_OUT_1_HEIGHT      (1)
#define AI_NETWORK_1701866511190_OUT_1_CHANNEL     (1)
#define AI_NETWORK_1701866511190_OUT_1_SIZE        (1 * 1)
#define AI_NETWORK_1701866511190_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_1701866511190_N_NODES (12)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_1701866511190
 ...
 * @ref ai_network_1701866511190_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_1701866511190_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1701866511190_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_1701866511190_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_1701866511190_*
 * defines into file @ref network_1701866511190.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_1701866511190_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_1701866511190_H */
