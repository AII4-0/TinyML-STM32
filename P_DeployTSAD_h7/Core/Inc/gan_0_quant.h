...
#ifndef TENSORFLOW_LITE_UTIL_GAN_0_QUANT_DATA_H_
#define TENSORFLOW_LITE_UTIL_GAN_0_QUANT_DATA_H_

extern const unsigned char gan_0_quant[];
extern const int gan_0_quant_len;

#endif  // TENSORFLOW_LITE_UTIL_GAN_0_QUANT_DATA_H_
