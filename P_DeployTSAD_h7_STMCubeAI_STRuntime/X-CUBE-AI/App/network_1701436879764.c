/**
  ******************************************************************************
  * @file    network_1701436879764.c
  * @author  AST Embedded Analytics Research Platform
  * @date    Fri Dec  1 14:24:56 2023
...
#include "network_1701436879764.h"
#include "network_1701436879764_data.h"
...
#define AI_NET_OBJ_INSTANCE g_network_1701436879764
 
#undef AI_NETWORK_1701436879764_MODEL_SIGNATURE
#define AI_NETWORK_1701436879764_MODEL_SIGNATURE     "9338d397e161973af17109e27ddbaf15"
...
#define AI_TOOLS_DATE_TIME   "Fri Dec  1 14:24:56 2023"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_NETWORK_1701436879764_N_BATCHES
#define AI_NETWORK_1701436879764_N_BATCHES         (1)

static ai_ptr g_network_1701436879764_activations_map[1] = AI_C_ARRAY_INIT;
static ai_ptr g_network_1701436879764_weights_map[1] = AI_C_ARRAY_INIT;
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    512, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1701436879764_IN_NUM, &serving_default_args_00_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_1701436879764_OUT_NUM, &conversion_13_output),
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1701436879764_configure_activations(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_activations_map(g_network_1701436879764_activations_map, 1, params)) {
    /* Updating activations (byte) offsets */
    
    serving_default_args_00_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 116);
    serving_default_args_00_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 116);
    
    conversion_0_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 16);
    conversion_0_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 16);
    
    gemm_2_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 116);
    gemm_2_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 116);
    
    gemm_2_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    gemm_2_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    
    gemm_3_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 128);
    gemm_3_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 128);
    
    gemm_3_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    gemm_3_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    gemm_4_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 128);
    gemm_4_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 128);
    
    gemm_4_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    gemm_4_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    
    gemm_5_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    gemm_5_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    gemm_5_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 256);
    gemm_5_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 256);
    
    nl_6_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    nl_6_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    gemm_7_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 100);
    gemm_7_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 100);
    
    gemm_7_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    gemm_7_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    
    gemm_8_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    gemm_8_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    gemm_8_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 256);
    gemm_8_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 256);
    
    gemm_9_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    gemm_9_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    gemm_9_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    gemm_9_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 384);
    
    gemm_10_scratch0_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    gemm_10_scratch0_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    gemm_10_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 256);
    gemm_10_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 256);
    
    nl_11_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    nl_11_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 0);
    
    conversion_13_output_array.data = AI_PTR(g_network_1701436879764_activations_map[0] + 4);
    conversion_13_output_array.data_start = AI_PTR(g_network_1701436879764_activations_map[0] + 4);
...
/******************************************************************************/
AI_DECLARE_STATIC
ai_bool network_1701436879764_configure_weights(
  ai_network* net_ctx, const ai_network_params* params)
{
  AI_ASSERT(net_ctx)

  if (ai_platform_get_weights_map(g_network_1701436879764_weights_map, 1, params)) {
    /* Updating weights (byte) offsets */
    
    gemm_10_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_10_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 0);
    gemm_10_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 0);
    
    gemm_10_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_10_bias_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 128);
    gemm_10_bias_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 128);
    
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 132);
    gemm_2_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 132);
    
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 12804);
    gemm_2_bias_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 12804);
    
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 13316);
    gemm_3_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 13316);
    
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 29700);
    gemm_3_bias_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 29700);
    
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 30212);
    gemm_4_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 30212);
    
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 46596);
    gemm_5_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 46596);
    
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 59268);
    gemm_5_bias_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 59268);
    
    gemm_7_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 59664);
    gemm_7_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 59664);
    
    gemm_8_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_8_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 72336);
    gemm_8_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 72336);
    
    gemm_8_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_8_bias_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 88720);
    gemm_8_bias_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 88720);
    
    gemm_9_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_weights_array.data = AI_PTR(g_network_1701436879764_weights_map[0] + 89232);
    gemm_9_weights_array.data_start = AI_PTR(g_network_1701436879764_weights_map[0] + 89232);
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_network_1701436879764_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_NETWORK_1701436879764_MODEL_NAME,
      .model_signature   = AI_NETWORK_1701436879764_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_bool ai_network_1701436879764_get_report(
  ai_handle network, ai_network_report* report)
{
  ai_network* net_ctx = AI_NETWORK_ACQUIRE_CTX(network);
...
AI_API_ENTRY
ai_error ai_network_1701436879764_get_error(ai_handle network)
{
  return ai_platform_network_get_error(network);
}

AI_API_ENTRY
ai_error ai_network_1701436879764_create(
...
AI_API_ENTRY
ai_error ai_network_1701436879764_create_and_init(
  ai_handle* network, const ai_handle activations[], const ai_handle weights[])
{
    ai_error err;
    ai_network_params params;

    err = ai_network_1701436879764_create(network, AI_NETWORK_1701436879764_DATA_CONFIG);
    if (err.type != AI_ERROR_NONE)
        return err;
    if (ai_network_1701436879764_data_params_get(&params) != true) {
        err = ai_network_1701436879764_get_error(*network);
        return err;
    }
#if defined(AI_NETWORK_1701436879764_DATA_ACTIVATIONS_COUNT)
    if (activations) {
...
#endif
#if defined(AI_NETWORK_1701436879764_DATA_WEIGHTS_COUNT)
    if (weights) {
...
#endif
    if (ai_network_1701436879764_init(*network, &params) != true) {
        err = ai_network_1701436879764_get_error(*network);
    }
    return err;
}
...
AI_API_ENTRY
ai_buffer* ai_network_1701436879764_inputs_get(ai_handle network, ai_u16 *n_buffer)
{
...
AI_API_ENTRY
ai_buffer* ai_network_1701436879764_outputs_get(ai_handle network, ai_u16 *n_buffer)
{
  if (network == AI_HANDLE_NULL) {
    network = (ai_handle)&AI_NET_OBJ_INSTANCE;
    ((ai_network *)network)->magic = AI_MAGIC_CONTEXT_TOKEN;
...
AI_API_ENTRY
ai_handle ai_network_1701436879764_destroy(ai_handle network)
{
  return ai_platform_network_destroy(network);
}

AI_API_ENTRY
ai_bool ai_network_1701436879764_init(
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= network_1701436879764_configure_weights(net_ctx, params);
  ok &= network_1701436879764_configure_activations(net_ctx, params);
...
AI_API_ENTRY
ai_i32 ai_network_1701436879764_run(
...
AI_API_ENTRY
ai_i32 ai_network_1701436879764_forward(ai_handle network, const ai_buffer* input)
{
