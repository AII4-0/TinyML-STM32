...
#ifndef TENSORFLOW_LITE_UTIL_LSTM_0_QUANT_DATA_H_
#define TENSORFLOW_LITE_UTIL_LSTM_0_QUANT_DATA_H_

extern const unsigned char lstm_0_quant[];
extern const int lstm_0_quant_len;

#endif  // TENSORFLOW_LITE_UTIL_LSTM_0_QUANT_DATA_H_
