...
#ifndef TENSORFLOW_LITE_UTIL_LSTM_0_DATA_H_
#define TENSORFLOW_LITE_UTIL_LSTM_0_DATA_H_

extern const unsigned char lstm_0[];
extern const int lstm_0_len;

#endif  // TENSORFLOW_LITE_UTIL_LSTM_0_DATA_H_
